...
<div class="container">
    ...
    <div class="col-md-9 ftco-animate mb-0 text-center">
        <p class="breadcrumbs mb-0"><span class="mr-2"><a href="{{asset('/')}}">Trang chủ <i class="fa fa-chevron-right"></i></a></span> <span>Khác</span></p>
        <h1 class="mb-0 bread">Khác</h1>
    </div>
    </div>
</div>
</section>
			...
			<div class="col text-center">
                <div class="block-27">
                    ...
                    @for ($i = 0 ; $i < $postCount ; $i++)
                        <li><a href="{{asset('other?page='. ($i+1))}}">{{$i + 1}}</a></li>
                    @endfor
                    <li><a href="other?page={{$postCount}}">&gt;&gt;</a></li>
                    </ul>
                </div>
            </div>
		</div>
